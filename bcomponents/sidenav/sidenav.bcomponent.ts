...
export class SidenavBComponent extends BComponent {
    ...
    public Initialize = (component: any = null, brand: LinkBComponent = null, items: SidenavItem[] = [], hamburger: boolean = true, overlay: boolean = true) => {
