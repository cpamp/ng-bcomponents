...
@Component({
    ...
    inputs: BComponentInputs.concat('component', 'brand', 'items', 'hamburger', 'overlay', 'startOpen')
})
export class SidenavBComponent extends BComponent {
    ...
    public Initialize = (component: any = null, brand: LinkBComponent = null, items: SidenavItem[] = [], hamburger: boolean = true, overlay: boolean = true, startOpen: boolean = true) => {
